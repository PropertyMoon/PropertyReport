...
RESEARCH_TASKS = {
    ...
    "property_market": (
        ...
        "STEP 1 — Fetch the RateMyAgent page directly (MOST RELIABLE):\n"
        "(a) Search: \"{address} site:ratemyagent.com.au\"\n"
        "(b) From the search results, get the full ratemyagent.com.au URL for this property.\n"
        "(c) Fetch/open that URL. In the page text look for the phrase 'Last sold for $' — "
        "the dollar amount right after it is the sold price. "
        "Also look for a date near that amount (e.g. '24 Feb 2025'). "
        "This text is in the server-rendered HTML — it will be present on the page.\n\n"
        "STEP 2 — If step 1 found no URL or no price, search:\n"
        "\"{address} sold realestate.com.au\"\n"
        "Read the price from the Google snippet text.\n\n"
        "STEP 3 — If step 2 found nothing, search:\n"
