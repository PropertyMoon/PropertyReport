...
RESEARCH_TASKS_PERPLEXITY = {
    "suburb": (
        ...
        "Only include a place if it is the geographically closest verified option for each category.\n"
        "Return walking distance where possible; otherwise use the best available street-level distance.\n"
