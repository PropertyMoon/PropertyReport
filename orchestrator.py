...
RESEARCH_TASKS = {
    ...
    "property_market": (
        ...
        "STEP 1 — Search ratemyagent.com.au (most reliable — open pages, prices are in plain text):\n"
        "Search Google for: \"{address} site:ratemyagent.com.au\"\n"
        "Open the result page and read the sold price and date directly from the page content.\n\n"
        "STEP 2 — Read the Google search SNIPPET:\n"
        "Search Google for: \"{address} sold\"\n"
        "Read the sold price directly from the Google snippet text — look for '$X,XXX,XXX' near 'Sold on'.\n\n"
        "STEP 3 — If steps 1-2 have no price, search:\n"
        "\"{address} sold realestate.com.au\"\n"
        "Read the dollar amount from the Google snippet text (do NOT rely on the page itself).\n\n"
        "STEP 4 — If step 3 has no price, search:\n"
        "\"{address} sold domain.com.au\"\n"
        "Read from the snippet text.\n\n"
