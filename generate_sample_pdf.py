...
report = PropertyReport(
    ...
    suburb={
        ...
        "nearby_gps":           [{"name": "Watergardens Medical Centre", "distance_km": 1.0}],
        "nearby_hospitals":     [{"name": "Sunshine Hospital", "distance_km": 8.5}],
        "nearby_supermarkets":  [{"name": "Woolworths Watergardens", "distance_km": 0.4}],
        "nearby_parks":         [{"name": "Taylors Lakes Reserve", "distance_km": 0.7}],
        "nearby_gyms":          [{"name": "Anytime Fitness", "distance_km": 0.9, "weekly_cost_aud": 18}],
        "crime_trend_3yr": [
